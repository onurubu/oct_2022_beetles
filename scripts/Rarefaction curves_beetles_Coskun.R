...
# 1. Read CSV
beetles <- read.csv(
  "./working_beetle_data/Matrix_beetles.csv",
  sep = ",",
  header = TRUE,
...
group1 <- c("0 m W", "200 W", "300 W", "500 W", "700 W", "900 W")

group2 <- c("1100 W", "1300 W", "1500 W", "1700 W", "1900 W (Peak)")

group3 <- c("1700 E", "1500 E", "1300 E", "1100 E", "900 E", "500 E")
...
group1 <- c("0  W", "200 W", "300 W", "500 W", "700 W", "900 W")
